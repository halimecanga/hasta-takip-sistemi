const tabs = [
  { key: 'overview', label: 'Reçete Özeti' },
  { key: 'instructions', label: 'Kullanım Talimatları' },
  { key: 'history', label: 'Geçmiş' },
  { key: 'documents', label: 'Belgeler' },
]

export default function PrescriptionTabs({ activeTab, onChange }) {
  return (
    <div className="-mx-1 mb-5 overflow-x-auto px-1" role="tablist" aria-label="Reçete detay sekmeleri">
